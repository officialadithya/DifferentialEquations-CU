...
\section{Lectures 16, February 27, 2023}
...
\section{Lecture 17, March 1, 2023 \& Lecture 18, March 3, 2023}

    \subsection{The Method of Undetermined Coefficients: Part II}

        Consider the following cases that often arise with the Method of Undetermined Coefficients.
        \begin{enumerate}
            \item The forcing term \(Q(x)\) contains no term \(u(x)=x^ky_i(x)\) for \(k\in\mathbb{N}\) and \(y_i(x)\) a term of \(y_c(x)\).
            \item The forcing term \(Q(x)\) contains a term \(u(x)=x^ky_i(x)\) for \(k\in\mathbb{N}\) and \(y_i(x)\) a term of \(y_c(x)\) arising from a root of multiplicity \(r_i\). Here \(y_p(x)\) is a liner combination of \(x^{k+r}u(x)\), all its linearly independent derivatives, and all linearly independent derivatives of the above case's terms.
        \end{enumerate}
